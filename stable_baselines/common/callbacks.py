...
class EvalCallback(EventCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            episode_rewards, episode_lengths, episode_success = evaluate_policy(self.model, self.eval_env,
...
class StopTrainingOnSuccessThreshold(BaseCallback):
    ...
    def __init__(self, success_rate_goal: float, verbose: int = 0):
        super(StopTrainingOnSuccessThreshold, self).__init__(verbose=verbose)
        self.success_rate_goal = success_rate_goal
